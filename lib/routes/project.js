...
exports.info = function(req, res) {
  ...
  vendors.mysql.getConnection(function(err, connection) {
    ...
    connection.query('SELECT * FROM project WHERE ID =?', id, function(error, results, fields) {
      connection.release();
...
exports.applInfo = function(req, res) {
  ...
  vendors.mysql.getConnection(function(err, connection) {
    ...
    connection.query('SELECT * FROM application WHERE projectid = ?', id, function(error, results, fields) {
      connection.release();
...
exports.update = function(req, res) {
  ...
  vendors.mysql.getConnection(function(err, connection) {
    ...
    connection.query('UPDATE project SET ? WHERE id = ?', [values, req.user.id], function(error, results, fields) {
      connection.release();
